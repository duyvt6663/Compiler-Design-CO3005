...
funcdecl: ID COLON Function functype LB paramlist? RB (Inherit ID)? blockstmt;
...
/* Keywords */
keyword: 
    INTEGER | FLOAT | STRING | ARRAY | AUTO | VOID | // data type
    Function | Break | Continue | If | Else | For | While | Return | Of | Do | Out | Inherit | TRue | FAlse; // syntax items
Function: 'function';
Break: 'break';
Continue: 'continue';
If: 'if';
